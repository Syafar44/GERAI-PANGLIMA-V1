        ...
        <div>
            ...
            <section>
                <div className="flex flex-col md:flex-row items-center justify-center p-10 gap-10">
                    <Link href={`https://wa.me/082220002237`} target="_blank" className="card bg-base-100 hover:scale-90 transition-all duration-300 ease-in-out shadow dark:bg-white">
                    ...
                    <Link href={`https://id.shp.ee/ihbWd7j`} target="_blank" className="card bg-base-100 hover:scale-90 transition-all duration-300 ease-in-out shadow dark:bg-white">
                        <div className="bg-primary p-10 flex justify-center rounded-t-xl">
                    ...
                    <Link href={`https://vt.tiktok.com/ZSDn4MrGf/?page=Mall`} target="_blank" className="card bg-base-100 hover:scale-90 transition-all duration-300 ease-in-out shadow dark:bg-white">
                        <div className="bg-primary p-10 flex justify-center rounded-t-xl">
